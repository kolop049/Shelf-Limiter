...
![Shelf Limiter](About/Preview.png)

A lightweight **RimWorld 1.6** mod that adds a small maximum-amount field beside every resource in the vanilla shelf storage menu.
